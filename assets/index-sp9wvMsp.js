...
`,
  ...
  m = [
    ...
    [
      ...
      `奥斯陆`,
      `抵达奥斯陆`,
      `抵达 OSL 后前往 Oslo S，入住 Comfort Hotel Grand Central。`,
      `OSL → Oslo S`,
      `酒店已确认；次日从 Oslo S 乘机场快线前往 OSL。`,
    ],
    [
      `09.27`,
      `周日`,
      `斯瓦尔巴`,
      `飞抵北纬 78°`,
      `从奥斯陆飞往朗伊尔城，入住 Svalbard Hotell | Polfareren。`,
      `OSL → LYR · 已出票`,
      `酒店已支付；机场巴士可前往镇中心。`,
    ],
    [
    ...
    [
      ...
      `奥斯陆`,
      `主行程结束 · 个人延长段开始`,
      `同行者按原计划启程回国；个人从机场区域返回 Oslo S，入住 Comfort Hotel Grand Central，开始两晚奥斯陆自由行。`,
      `1 人延长 · 酒店已确认`,
      `Compact Double，含早餐、不可退款；入住前寄存与到店时间按酒店政策执行。`,
    ],
    [
      `10.07`,
      `周三`,
      `奥斯陆`,
      `个人奥斯陆自由日`,
      `以城市步行、博物馆或攀岩体验为主，按体力与天气现场选择；继续入住 Comfort Hotel Grand Central。`,
      `1 人自由安排 · 第 2 晚`,
      `不要安排影响次日国际返程的远距离项目。`,
    ],
    [
  ...
  g = [
    [
      ...
      `航班`,
      `国际往返航班`,
      `09.25 两人 CAN→AMS→OSL；同行者 10.06 返程，个人改签为 10.08 OSL→BKK→HKG。原国际机票两人合计 ¥22,856；改签差额尚未登记。`,
      ``,
      `已支付`,
      `locked`,
    ],
        ...
        children: [
          (0, p.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, p.jsx)(`p`, {
                className: `date`,
                children: `2026.09.25 — 10.09 · 15 天 / 13 晚`,
              }),
              (0, p.jsxs)(`p`, {
                className: `route`,
                children: [
        ...
        children: [
          ...
          (0, p.jsxs)(`div`, {
            children: [
              ...
              (0, p.jsx)(`b`, { children: `12 晚` }),
              (0, p.jsx)(`small`, {
                children: `两人主行程 10＋个人奥斯陆延长 2`,
              }),
            ],
          }),
          (0, p.jsxs)(`div`, {
        ...
        children: [
          (0, p.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, p.jsx)(`p`, {
                children: `4 项核心活动已锁定；3 项机动安排保持“尚未预订”，只在天气、路况、体力与睡眠允许时执行。`,
              }),
            ],
          }),
          (0, p.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, p.jsxs)(`div`, {
            children: [
              ...
              (0, p.jsx)(`p`, {
                children: `版本日期：2026.09.22 · 已确认项目以预订、付款与出票记录为准。`,
              }),
            ],
          }),
