...
`,
  ...
  m = [
    [
      ...
      `奥斯陆`,
      `14:20 抵达奥斯陆 · 入住`,
      `CZ307 经阿姆斯特丹转 KL1203，14:20（挪威当地时间）抵达 OSL；前往 Oslo S，入住 Comfort Hotel Grand Central（09.25→09.26）。`,
      `KL1203 14:20 OSL · 当晚住宿已订`,
      `今晚与明晚是两笔相邻订单：前台确认 09.25→09.26 和 09.26→09.27 是否可以不换房；不要误把抵达日算成 09.26。`,
    ],
    [
      `09.26`,
      `周六`,
      `奥斯陆`,
      `完整奥斯陆日 · 城市与海滨`,
      `白天从 Oslo S 步行至 Deichman 图书馆、歌剧院屋顶和 Bjørvika 海滨；下午参观 MUNCH 或国家博物馆。今晚继续入住 Comfort Hotel Grand Central（第二笔 09.26→09.27）。`,
      `全天在城内 · 第二晚已订`,
      `晚间整理次日北上行李；09.27 10:20 SK4492，建议提前到 OSL 办理出境手续。`,
    ],
    [
      `09.27`,
      `周日`,
      `斯瓦尔巴`,
      `飞抵北纬 78°`,
      `从 Comfort Hotel Grand Central 退房后前往 OSL；10:20 乘 SK4492 飞朗伊尔城，13:15 抵达并入住 Svalbard Hotell | Polfareren。`,
      `10:20 OSL → 13:15 LYR · 已出票`,
      `斯瓦尔巴在申根区外，预留出境和值机时间；酒店已支付。`,
    ],
    [
      `09.28`,
      `周一`,
      `斯瓦尔巴`,
      `峡湾、冰川与野生动物出海`,
      `08:15 从 Tourist Information Centre 集合，搭乘 MS Bard 混合动力双体船前往 Billefjorden 与 Nordenskiöldbreen；船上配向导并含午餐。`,
      `08:15 集合 · MS Bard · 已支付`,
      `海况、浮冰与运营方安全判断可能影响航线；按通知提前到达集合点。`,
    ],
    [
      `09.29`,
      `周二`,
      `斯瓦尔巴`,
      `Foxfonna 徒步穿越`,
      `10:00 从 Tourist Information Centre 集合，参加 Green Dog Svalbard 的 Hike Across Foxfonna with packdog；活动约 6 小时，含简餐与热饮。`,
      `10:00 集合 · 约 6 小时 · 已支付`,
      `按全天户外强度准备保暖、防风防水层；路线与执行以向导及天气判断为准。`,
    ],
    [
      `09.30`,
      `周三`,
      `斯瓦尔巴`,
      `天气机动与室内备选`,
      `优先承接 09.28—09.29 因海况或天气取消的核心项目；若无需补位，再从矿井、博物馆或朗伊尔城步行中选择。`,
      `全天机动 · 尚未预订`,
      `不提前叠加不可取消项目，前一晚按天气与体力决定。`,
    ],
    [
      `10.01`,
      `周四`,
      `斯瓦尔巴`,
      `轮式狗拉雪橇`,
      `09:00 从 Tourist Information Centre 集合，参加 Green Dog Svalbard 的 4 小时 Dog sledding on wheels；约 13:00 返回，提供户外服装、雨具、靴子、手套、热饮与华夫饼。`,
      `09:00—约 13:00 · 已支付`,
      `活动由经验丰富的持枪向导带领；按运营方通知确认最终接送时间。`,
    ],
    [
      `10.02`,
      `周五`,
      `特罗姆瑟`,
      `抵达特罗姆瑟 · 极光追猎`,
      `乘 SK4425 从朗伊尔城飞往特罗姆瑟，入住 Scandic Ishavshotel；19:00 在 Clarion The Edge Hotel 集合，预计次日 02:00 结束。`,
      `14:10 抵达 TOS · 19:00 追光`,
      `返抵挪威本土需再次入境申根；落地后有约 4 小时 50 分钟衔接余量。`,
    ],
    [
      `10.03`,
      `周六`,
      `特罗姆瑟`,
      `城市漫游与恢复日`,
      `追光团预计 02:00 结束；白天根据睡眠、天气与云量，在港区步行、室内景点或缆车之间现场选择。`,
      `白天低负荷 · 尚未预订`,
      `不再叠加另一场通宵活动，优先恢复睡眠。`,
    ],
    [
      ...
      `特罗姆瑟`,
      `自驾前往塞尼亚`,
      `10:00 在 Tromsø Langnes Airport 提取 Toyota RAV4 或同级自动挡车辆，驶往塞尼亚西海岸并入住 Hamn i Senja。`,
      `10:00 TOS 取车 · 无限里程`,
      `以道路、风雪与次日返程安全为最高优先级。`,
    ],
    [
      ...
      `奥斯陆`,
      `返回奥斯陆`,
      `从塞尼亚返回 Tromsø Langnes Airport，16:00 还车后飞往奥斯陆，入住 Radisson Blu Airport Hotel。`,
      `16:00 TOS 还车 · TOS → OSL 已出票`,
      `机场酒店 10.05→10.06；次日同行者回国，你留在奥斯陆。`,
    ],
    [
      `10.06`,
      `周二`,
      `奥斯陆`,
      `同行者返程 · 个人延长段开始`,
      `同行者按原票返回香港；你前往 Oslo S，入住 Comfort Hotel Grand Central，开始两晚奥斯陆个人行程。`,
      `1 人延长 · 10.06→10.08 已订`,
      `延长段为 Compact Double、含早餐、不可退款；不要把你的返程写成 10.06。`,
    ],
    [
      `10.07`,
      `周三`,
      `奥斯陆`,
      `个人奥斯陆自由日`,
      `按体力与天气选择城市步行、博物馆或攀岩体验；继续入住 Comfort Hotel Grand Central。`,
      `1 人自由安排 · 延长段第 2 晚`,
      `不要安排影响次日国际返程的远距离项目。`,
    ],
    [
    ...
    [
      ...
      `路上`,
      `抵达香港`,
      `预计 14:20 抵达香港，个人延长段结束。`,
      `15 天 / 13 个住宿夜`,
      `同行者按原计划先返程；保留票据与保险文件。`,
    ],
  ],
  h = [
    {
      id: `oslo-day`, date: `09.26`, place: `奥斯陆`, title: `奥斯陆完整日 · 建筑与海滨`,
      subtitle: `Oslo S → Bjørvika → MUNCH`, operator: `自行步行 / 室内备选`,
      time: `10:00—19:00（可缩短）`, duration: `约 4—7 小时，随时休息`, meeting: `Comfort Hotel Grand Central / Oslo S`,
      plan: `10:00 从酒店步行看 Deichman 图书馆与歌剧院屋顶；午餐后沿 Bjørvika 海滨走到 MUNCH，选 1 个馆认真参观。若更偏传统艺术，可改国家博物馆，不必两个馆硬塞一天。`,
      includes: `步行免费；博物馆与餐饮按现场选择`, price: `尚未购买门票`, status: `自由安排`, locked: !1,
      note: `09.25 长途飞行后不排高强度攀岩；09.27 早起去机场。MUNCH 周六通常 10:00—21:00，临行核对当日开馆信息。`, link: `https://www.munch.no/en/visit-us/opening-hours/`,
      summary: `09.26 完整奥斯陆日；Oslo S—Deichman—歌剧院屋顶—Bjørvika—MUNCH，天气不好以室内博物馆为主；未购票。`,
    },
    {
      id: `svalbard-act`,
      date: `09.28`,
      place: `斯瓦尔巴`,
      title: `Wildlife and Glacier`,
      subtitle: `Hybrid Catamaran Tour · MS Bard`,
      operator: `Hurtigruten Svalbard`,
      time: `08:15 集合`,
      duration: `全天，以运营通知为准`,
      meeting: `Tourist Information Centre`,
      plan: `搭乘混合动力双体船前往 Billefjorden 与 Nordenskiöldbreen，沿途观察峡湾、冰川与野生动物。`,
      includes: `船上向导、午餐`,
      price: `NOK 5,990 / 2 人`,
      status: `已支付`,
      locked: !0,
      note: `海况、浮冰与能见度可能改变航线或导致取消。`,
      link: `https://hurtigrutensvalbard.com/`,
      summary: `09.28 08:15；Tourist Information Centre 集合；MS Bard 前往 Billefjorden 与 Nordenskiöldbreen，含向导及午餐；2 位成人共 NOK 5,990。`,
    },
    {
      id: `foxfonna-hike`,
      date: `09.29`,
      place: `斯瓦尔巴`,
      title: `Hike Across Foxfonna`,
      subtitle: `with packdog`,
      operator: `Green Dog Svalbard`,
      time: `10:00 集合`,
      duration: `约 6 小时`,
      meeting: `Tourist Information Centre`,
      plan: `由向导带领并与 packdog 一同穿越 Foxfonna；按全天户外强度准备保暖、防风与防水层。`,
      includes: `简餐、热饮`,
      price: `NOK 3,380 / 2 人`,
      status: `已支付`,
      locked: !0,
      note: `要求正常健康状况；路线与执行以天气和向导判断为准。`,
      link: `https://greendog.no/`,
      summary: `09.29 10:00；Tourist Information Centre 集合；Green Dog Svalbard，约 6 小时，含简餐与热饮；2 位成人共 NOK 3,380。`,
    },
    {
      id: `svalbard-flex`,
      date: `09.30`,
      place: `斯瓦尔巴`,
      title: `天气机动与室内备选`,
      subtitle: `Weather reserve day`,
      operator: `待天气确认`,
      time: `全天机动`,
      duration: `半日或全天`,
      meeting: `朗伊尔城`,
      plan: `先为前两日因天气取消的活动补位；无需补位时，再从矿井、博物馆或朗伊尔城步行中选择。`,
      includes: `按最终选择确定`,
      price: `尚未产生费用`,
      status: `尚未预订`,
      locked: !1,
      note: `前一晚再决定，不叠加不可取消项目。`,
      link: ``,
      summary: `09.30 全天；优先承接天气取消项目，否则从矿井、博物馆或朗伊尔城步行中选择；前一晚按天气决定。`,
    },
    {
      id: `dog-sledding`,
      date: `10.01`,
      place: `斯瓦尔巴`,
      title: `Dog sledding on wheels`,
      subtitle: `轮式狗拉雪橇`,
      operator: `Green Dog Svalbard`,
      time: `09:00—约 13:00`,
      duration: `4 小时`,
      meeting: `Tourist Information Centre`,
      plan: `参加轮式狗拉雪橇活动，由经验丰富的持枪向导全程带领，并按通知确认最终接送时间。`,
      includes: `接送、户外服装、雨具、靴子、手套、热饮与华夫饼`,
      price: `NOK 3,780 / 2 人`,
      status: `已支付`,
      locked: !0,
      note: `运营季为无雪路面方案，并非雪地雪橇。`,
      link: `https://greendog.no/`,
      summary: `10.01 09:00—约 13:00；Tourist Information Centre 集合；4 小时，含接送、装备、热饮与华夫饼；2 位成人共 NOK 3,780。`,
    },
    {
      id: `aurora`,
      date: `10.02`,
      ...
      time: `19:00—次日 02:00`,
      duration: `约 7 小时`,
      meeting: `Clarion The Edge Hotel`,
      plan: `抵达特罗姆瑟并入住后参加小团追光；落地至集合约有 4 小时 50 分钟衔接余量。`,
      includes: `以运营方确认单为准`,
      price: `NOK 4,017 / 2 人`,
      status: `已预订`,
      locked: !0,
      note: `极光无法保证；返程后次日只安排低负荷活动。`,
      link: `https://www.visittromso.no/northern-lights-tour-small-group`,
      summary: `10.02 19:00—次日 02:00；Clarion The Edge Hotel 集合；2 位成人，NOK 1,950/人＋服务费 NOK 117，总价 NOK 4,017。`,
    },
    {
      id: `tromso-flex`,
      date: `10.03`,
      place: `特罗姆瑟`,
      title: `城市漫游与恢复`,
      subtitle: `Post-aurora recovery`,
      operator: `自由安排`,
      time: `白天`,
      duration: `低负荷、时长机动`,
      meeting: `Scandic Ishavshotel 周边`,
      plan: `根据睡眠、天气与云量，在港区步行、室内景点或缆车之间现场选择，不设置刚性打卡。`,
      includes: `按现场选择确定`,
      price: `尚未产生费用`,
      status: `尚未预订`,
      locked: !1,
      note: `追光预计凌晨结束，睡眠优先。`,
      link: ``,
      summary: `10.03 白天；追光后的恢复窗口，按睡眠和天气从港区步行、室内景点或缆车中现场选择。`,
    },
    {
      id: `senja-flex`,
      date: `10.04`,
      place: `塞尼亚`,
      title: `塞尼亚沿途观景机动`,
      subtitle: `Tromsø → Hamn i Senja`,
      operator: `自驾安排`,
      time: `10:00 取车后`,
      duration: `随路况机动`,
      meeting: `Tromsø Langnes Airport`,
      plan: `驶往 Hamn i Senja，沿途是否停靠观景点由风雪、路况、能见度与剩余日照共同决定。`,
      includes: `车辆已预订；沿途活动未预订`,
      price: `未产生单独活动费用`,
      status: `尚未预订`,
      locked: !1,
      note: `抵达住宿与次日安全返程优先，不追求打卡数量。`,
      link: ``,
      summary: `10.04 取车后；Tromsø 前往 Hamn i Senja，沿途观景点按风雪、路况与能见度现场决定。`,
    },
  ],
  g = [
    [
      ...
      `航班`,
      `国际航班与分段返程`,
      `09.25 CZ307 CAN→AMS、KL1203 AMS→OSL（当地 14:20 抵达）；同行者 10.06 返回，你已改签 10.08 OSL→BKK→HKG。原机票两人合计 ¥22,856；改签差额未登记。`,
      ``,
      `已支付`,
      `locked`,
    ],
    [
      ...
      `航班`,
      `挪威三段国内航班`,
      `SK4492 OSL→LYR · US$484.80；SK4425 LYR→TOS · US$519.80；SK4431 TOS→OSL · US$311.80。`,
      ``,
      `已支付`,
      `locked`,
    ],
    [
      ...
      `09.27 入住—10.02 退房，共 5 晚；两人合计 ¥11,092.73。`,
      `https://www.booking.com/hotel/no/svalbard.html`,
      `已支付`,
      `locked`,
    ],
    [
      ...
      `住宿`,
      `Scandic Ishavshotel`,
      `10.02 入住—10.04 退房，共 2 晚；双床房，2 位成人；总价 NOK 4,822.20，已预订待支付。`,
      `https://www.booking.com/hotel/no/scandic-ishavshotel.html`,
      `已预订`,
      `locked`,
    ],
    [
      `osl-arrival-stay`,
      `住宿`,
      `Comfort Hotel Grand Central · 抵达当晚`,
      `09.25 入住—09.26 退房，共 1 晚；携程已预订，¥1,679.83，已授权离店后扣款。和次晚是两笔订单，向前台核实续住是否换房。`,
      ``,
      `已预订·待扣款`,
      `locked`,
    ],
    [
      ...
      `09.26 入住—09.27 退房，共 1 晚；2 位成人；两人合计 ¥1,853.46，已确认。`,
      `https://www.booking.com/hotel/no/comfort-grand-central.html`,
      `已预订`,
      `locked`,
    ],
    [
      ...
      `住宿`,
      `Hamn i Senja`,
      `10.04 入住—10.05 退房，共 1 晚；Hamnveien 1145, 9385 Hamn i Senja；已支付 ¥1,024.94。`,
      ``,
      `已支付`,
      `locked`,
    ],
    [
      ...
      `10.05 入住—10.06 退房，共 1 晚；2 位成人；两人合计 ¥1,242.36，已确认。`,
      `https://www.booking.com/hotel/no/radisson-blu-airport-oslo.html`,
      `已预订`,
      `locked`,
    ],
    [
      `osl-solo-extension`,
      `住宿`,
      `Comfort Hotel Grand Central · 个人延长段`,
      `10.06 入住—10.08 退房，共 2 晚；1 位成人，Compact Double，含早餐、不可退款；NOK 3,485.65（预订显示 CNY 2,475.36），已确认。`,
      `https://www.booking.com/hotel/no/comfort-grand-central.html`,
      `已预订`,
      `locked`,
    ],
    ...h.map((e) => [
      ...
      e.link,
      e.status,
      e.locked ? `locked` : `pending`,
    ]),
    [
      `car`,
      `交通`,
      `特罗姆瑟—塞尼亚租车`,
      `Toyota RAV4 或同级，自动挡、无限里程；10.04 10:00 在 Tromsø Langnes Airport 取车，10.05 16:00 原地还车；预计总价 NOK 4,217.29。`,
      ``,
      `已预订`,
      `locked`,
    ],
    [
      ...
      `手续`,
      `可两次进入申根区的签证`,
      `签证已签发；斯瓦尔巴在申根区外，返特罗姆瑟需要再次入境。`,
      `https://www.udi.no/en/word-definitions/svalbard/`,
      `已签发`,
      `locked`,
    ],
    [
  ...
  v = [
    [`2026.08.05`, `国际机票`, `两人国际往返`, 22856, `CNY`, `已支付`],
    [`2026.08.07`, `挪威航班`, `OSL→LYR · SK4492`, 484.8, `USD`, `已支付`],
    [`2026.08.07`, `挪威航班`, `LYR→TOS · SK4425`, 519.8, `USD`, `已支付`],
    [`2026.08.07`, `挪威航班`, `TOS→OSL · SK4431`, 311.8, `USD`, `已支付`],
    [
      `2026.08.08`,
      `住宿`,
      `Svalbard Hotell | Polfareren · 5 晚`,
      11092.73,
      `CNY`,
      `已支付`,
    ],
    ...
    [
      `2026.09.25`,
      `住宿`,
      `Comfort Hotel Grand Central · 09.25 抵达夜`,
      1679.83,
      `CNY`,
      `已授权·离店后扣款`,
    ],
    [
      `2026.08.13`,
      `住宿`,
      `Comfort Hotel Grand Central · 1 晚`,
      1853.46,
      `CNY`,
      `已预订`,
    ],
    [
      `2026.08.13`,
      `住宿`,
      `Radisson Blu Airport Hotel · 1 晚`,
      1242.36,
      `CNY`,
      `已预订`,
    ],
    [`2026.09.05`, `住宿`, `Hamn i Senja · 1 晚`, 1024.94, `CNY`, `已支付`],
    [
      `2026.09.22`,
      `住宿`,
      `Comfort Hotel Grand Central · 个人延长段 · 2 晚`,
      2475.36,
      `CNY`,
      `已预订·不可退款`,
    ],
    ...
    [
      `2026.09.06`,
      `活动`,
      `Northern Lights Tour Small Group · 2 人`,
      4017,
      `NOK`,
      `已预订`,
    ],
    [
      `2026.09.06`,
      `活动`,
      `Wildlife and Glacier · MS Bard · 2 人`,
      5990,
      `NOK`,
      `已支付`,
    ],
    [
      `2026.09.06`,
      `活动`,
      `Hike Across Foxfonna with packdog · 2 人`,
      3380,
      `NOK`,
      `已支付`,
    ],
    [
      `2026.09.06`,
      `活动`,
      `Dog sledding on wheels · 2 人`,
      3780,
      `NOK`,
      `已支付`,
    ],
  ],
  y = { date: `2026.09.06`, USD: 6.71057, NOK: 0.721253, CNY: 1 },
  b = [
    [`证件`, `护照、签证与纸质备份`],
    [`证件`, `保险英文凭证与紧急电话`],
    [`穿着`, `羊毛贴身层 × 2 套`],
  ...
  x = (e) => new Intl.NumberFormat(`zh-CN`).format(Math.round(e)),
  ee = (e) =>
...
function C(e) {
  ...
  return (
    ...
    (0, f.useEffect)(() => {
      r && localStorage.setItem(e, JSON.stringify(t));
    }, [e, r, t]),
    {
      value: t,
      toggle: (e) =>
  ...
  return (0, p.jsxs)(`div`, {
    ...
    children: [
      (0, p.jsxs)(`svg`, {
        viewBox: `0 0 720 520`,
        role: `img`,
        "aria-label": `广州、阿姆斯特丹、奥斯陆、朗伊尔城、特罗姆瑟、曼谷与香港路线图`,
        children: [
          (0, p.jsxs)(`g`, {
            className: `grid`,
            children: [
              (0, p.jsx)(`path`, {
                d: `M80 0V520M200 0V520M320 0V520M440 0V520M560 0V520M680 0V520M0 70H720M0 180H720M0 290H720M0 400H720`,
              }),
              (0, p.jsx)(`circle`, { cx: `380`, cy: `220`, r: `80` }),
              (0, p.jsx)(`circle`, { cx: `380`, cy: `220`, r: `155` }),
              (0, p.jsx)(`circle`, { cx: `380`, cy: `220`, r: `225` }),
            ],
          }),
          (0, p.jsx)(`path`, {
            className: `land`,
            d: `M68 470c57-72 94-64 130-127 31-54 41-84 90-109 49-25 63-87 111-103 38-13 70 4 94 32 23 27 12 56 44 72 48 25 82 17 115 62 31 42 38 91 68 126v47Z`,
          }),
          (0, p.jsx)(`path`, {
            className: `fly international`,
            d: `M132 448C205 370 286 354 355 315`,
          }),
          (0, p.jsx)(`path`, {
            className: `fly north`,
            d: `M355 315C409 244 434 164 472 103`,
          }),
          (0, p.jsx)(`path`, {
            className: `fly return`,
            d: `M472 103C452 178 424 224 404 250M404 250C465 330 396 402 250 454M250 454L145 466`,
          }),
          [
            [132, 448, `CAN`, `广州`],
            [319, 329, `AMS`, `阿姆斯特丹`],
            [355, 315, `OSL`, `奥斯陆`],
            [472, 103, `LYR · 78.2°N`, `朗伊尔城`],
            [404, 250, `TOS · 69.6°N`, `特罗姆瑟`],
            [250, 454, `BKK`, `曼谷`],
            [145, 466, `HKG`, `香港`],
          ].map(([e, t, n, r]) =>
            (0, p.jsxs)(
          ...
          (0, p.jsx)(`text`, {
            ...
            x: `495`,
            y: `45`,
            children: `ARCTIC OCEAN`,
          }),
          (0, p.jsx)(`path`, {
            className: `north-arrow`,
            d: `M655 95V24m0 0-8 20m8-20 8 20`,
          }),
          (0, p.jsx)(`text`, {
            className: `n`,
            x: `649`,
      ...
      (0, p.jsxs)(`div`, {
        className: `legend`,
        children: [
          (0, p.jsxs)(`span`, { children: [(0, p.jsx)(`i`, {}), `北上主线`] }),
          (0, p.jsxs)(`span`, { children: [(0, p.jsx)(`i`, {}), `返程`] }),
        ],
      }),
    ],
  });
...
function ne() {
  let [e, t] = (0, f.useState)(`全部`),
    [n, r] = (0, f.useState)(!1),
    [i, a] = (0, f.useState)(null),
    o = C(`arctic-booking-v2`),
    s = C(`arctic-kit-v2`);
  (0, f.useEffect)(
    () =>
      a(
        Math.max(
          0,
          Math.ceil(
            (new Date(`2026-09-25T00:00:00+08:00`).getTime() - Date.now()) /
              864e5,
          ),
        ),
      ),
  ...
  let c = (0, f.useMemo)(
      () => (e === `全部` ? m : m.filter((t) => t[2] === e)),
      [e],
    ),
    l = _.reduce((e, t) => e + t[1], 0),
    u = _.reduce((e, t) => e + t[2], 0),
    d = n ? 2 : 1,
    ne = g.filter((e) => e[6] === `locked`).length,
    re = new Set([
      ...g.filter((e) => e[6] === `locked`).map((e) => e[0]),
      ...o.value,
    ]),
    w = v.reduce((e, t) => e + S(t[3], t[4]), 0),
    ie = v
      .filter((e) => e[5] === `已支付`)
      .reduce((e, t) => e + S(t[3], t[4]), 0),
    ae = w - ie;
    ...
    children: [
        ...
        children: [
          (0, p.jsxs)(`a`, {
            ...
            children: [
              (0, p.jsxs)(`span`, {
                className: `mountains`,
                children: [(0, p.jsx)(`i`, {}), (0, p.jsx)(`i`, {})],
              }),
              (0, p.jsx)(`b`, { children: `北纬 78°` }),
              (0, p.jsx)(`small`, { children: `ARCTIC FIELD LOG` }),
            ],
          }),
          (0, p.jsxs)(`nav`, {
            children: [
              (0, p.jsx)(`a`, { href: `#plan`, children: `行程` }),
              (0, p.jsx)(`a`, { href: `#activities`, children: `活动` }),
              (0, p.jsx)(`a`, { href: `#book`, children: `预订` }),
              (0, p.jsx)(`a`, { href: `#budget`, children: `预算` }),
              (0, p.jsx)(`a`, { href: `#kit`, children: `装备` }),
            ],
          }),
          (0, p.jsxs)(`a`, {
            href: `#book`,
            className: `status`,
            children: [(0, p.jsx)(`i`, {}), ne, `/`, g.length, ` 已锁定`],
          }),
        ],
      }),
      (0, p.jsxs)(`section`, {
        ...
        children: [
          (0, p.jsxs)(`div`, {
            ...
            children: [
              (0, p.jsx)(`p`, {
                className: `eyebrow`,
                children: `EXPEDITION FILE / 2026—09`,
              }),
              (0, p.jsxs)(`h1`, {
                children: [`北纬`, (0, p.jsx)(`br`, {}), `78°`],
              }),
              (0, p.jsx)(`h2`, { children: `两个人的北极作战地图` }),
              (0, p.jsx)(`div`, { className: `orange` }),
              (0, p.jsx)(`p`, {
                className: `date`,
                children: `2026.09.25 — 10.09 · 15 天 / 13 个住宿夜`,
              }),
              (0, p.jsxs)(`p`, {
                className: `route`,
                children: [
              ...
              (0, p.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, p.jsx)(`a`, { href: `#book`, children: `开始预订 ↗` }),
                ],
              }),
              (0, p.jsx)(`small`, {
                className: `count`,
                children: i === null ? `校准行程日期…` : i === 0 ? `行程进行中 · 所有日期按当地日历核对` : `距出发 ${i} 天`,
              }),
            ],
          }),
          (0, p.jsx)(te, {}),
      ...
      (0, p.jsxs)(`section`, {
        ...
        children: [
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`span`, { children: `成员` }),
              (0, p.jsx)(`b`, { children: `2 人主行程` }),
              (0, p.jsx)(`small`, { children: `10.06 起 1 人延长` }),
            ],
          }),
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`span`, { children: `最北点` }),
              (0, p.jsx)(`b`, { children: `78.2° N` }),
              (0, p.jsx)(`small`, { children: `Longyearbyen` }),
            ],
          }),
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`span`, { children: `已锁定住宿` }),
              (0, p.jsx)(`b`, { children: `13 夜` }),
              (0, p.jsx)(`small`, {
                children: `09.25—10.08 每夜均有已订房间`,
              }),
            ],
          }),
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`span`, { children: `当前费用折算` }),
              (0, p.jsxs)(`b`, { children: [`¥`, x(w)] }),
              (0, p.jsxs)(`small`, {
                children: [`已支付 ¥`, ee(ie), ` · 汇率固定于 09.06`],
              }),
            ],
          }),
          (0, p.jsxs)(`div`, {
            className: `boundary`,
            children: [
              (0, p.jsx)(`span`, { children: `任务边界 / 90°N` }),
              (0, p.jsx)(`p`, {
                children: `此季节无法合理抵达地理北极点。本计划把“北极”落实为北纬 78° 的斯瓦尔巴。`,
              }),
            ],
          }),
        ],
            ...
            children: [
              (0, p.jsxs)(`div`, {
                children: [
                  (0, p.jsx)(`p`, {
                    className: `eyebrow`,
                    children: `01 / DAILY LOG`,
                  }),
                  (0, p.jsx)(`h2`, { children: `逐日行程` }),
                ],
              }),
              (0, p.jsx)(`p`, {
                children: `两人主行程及 10.06—10.08 个人奥斯陆延长段均已锁定；继续保留天气机动。`,
              }),
            ],
          }),
          (0, p.jsx)(`div`, {
            className: `filters`,
            children: [`全部`, `特罗姆瑟`, `斯瓦尔巴`, `奥斯陆`, `路上`].map(
              (n) =>
                (0, p.jsxs)(
                  `button`,
                  {
                  ...
                  children: [
                    (0, p.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, p.jsx)(`strong`, { children: e[0] }),
                        (0, p.jsx)(`small`, { children: e[1] }),
                      ],
                    }),
                    (0, p.jsx)(`span`, {
                      className: `place p-${e[2]}`,
                      children: e[2],
                    }),
                    (0, p.jsxs)(`div`, {
                      className: `task`,
                      children: [
                        (0, p.jsx)(`h3`, { children: e[3] }),
                        (0, p.jsx)(`p`, { children: e[4] }),
                        (0, p.jsx)(`b`, { children: e[5] }),
                      ],
                    }),
                    (0, p.jsxs)(`div`, {
                      className: `note`,
                      children: [
                        (0, p.jsx)(`small`, { children: `NOTE` }),
                        (0, p.jsx)(`p`, { children: e[6] }),
                      ],
                    }),
                  ],
                },
      ...
      (0, p.jsxs)(`section`, {
        className: `visa`,
        children: [
          (0, p.jsx)(`b`, { children: `02×` }),
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`p`, {
                className: `eyebrow`,
                children: `BORDER CONTROL / 必看`,
              }),
              (0, p.jsx)(`h2`, { children: `需要可两次进入申根区` }),
              (0, p.jsx)(`p`, {
                children: `斯瓦尔巴不属于申根区。从奥斯陆飞朗伊尔城时离开申根，返特罗姆瑟时重新进入；签证必须支持第二次入境。`,
              }),
            ],
          }),
          (0, p.jsx)(`a`, {
            href: `https://www.udi.no/en/word-definitions/svalbard/`,
            target: `_blank`,
            rel: `noreferrer`,
            children: `挪威移民局说明 ↗`,
          }),
            ...
            children: [
              (0, p.jsxs)(`div`, {
                children: [
                  (0, p.jsx)(`p`, {
                    className: `eyebrow`,
                    children: `02 / ACTIVITY DOSSIER`,
                  }),
                  (0, p.jsx)(`h2`, { children: `活动档案` }),
                ],
              }),
              (0, p.jsx)(`p`, {
                children: `4 项核心活动已锁定；奥斯陆完整日与天气机动仍按体力灵活安排，未购票的不标成已预订。`,
              }),
            ],
          }),
          (0, p.jsxs)(`div`, {
            ...
            children: [
              (0, p.jsxs)(`div`, {
                children: [
                  (0, p.jsx)(`b`, {
                    children: h.filter((e) => e.locked).length,
                  }),
                  (0, p.jsx)(`span`, { children: `已锁定` }),
                ],
              }),
              (0, p.jsxs)(`div`, {
                children: [
                  ...
                  (0, p.jsx)(`span`, { children: `尚未预订` }),
                ],
              }),
              (0, p.jsx)(`p`, {
                children: `所有金额均为两人合计；订单号、票号、姓名与出生日期不公开。`,
              }),
            ],
          }),
          (0, p.jsx)(`div`, {
            ...
            children: h.map((e, t) =>
              (0, p.jsxs)(
                `article`,
                {
                  className: `activity-card ${e.locked ? `activity-locked` : `activity-pending`}`,
                  children: [
                    (0, p.jsxs)(`div`, {
                      ...
                      children: [
                        (0, p.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, p.jsx)(`b`, { children: e.date }),
                            (0, p.jsx)(`span`, { children: e.place }),
                          ],
                        }),
                        (0, p.jsx)(`em`, { children: e.status }),
                      ],
                    }),
                    ...
                    (0, p.jsxs)(`dl`, {
                      children: [
                        (0, p.jsxs)(`div`, {
                          children: [
                            (0, p.jsx)(`dt`, { children: `时间` }),
                            (0, p.jsx)(`dd`, { children: e.time }),
                          ],
                        }),
                        (0, p.jsxs)(`div`, {
                          children: [
                            (0, p.jsx)(`dt`, { children: `时长` }),
                            (0, p.jsx)(`dd`, { children: e.duration }),
                          ],
                        }),
                        (0, p.jsxs)(`div`, {
                          children: [
                            (0, p.jsx)(`dt`, { children: `运营 / 方式` }),
                            (0, p.jsx)(`dd`, { children: e.operator }),
                          ],
                        }),
                        (0, p.jsxs)(`div`, {
                          children: [
                            (0, p.jsx)(`dt`, { children: `集合 / 起点` }),
                            (0, p.jsx)(`dd`, { children: e.meeting }),
                          ],
                        }),
                        (0, p.jsxs)(`div`, {
                          className: `activity-includes`,
                          children: [
                            (0, p.jsx)(`dt`, { children: `包含 / 安排` }),
                            (0, p.jsx)(`dd`, { children: e.includes }),
                          ],
                        }),
                      ],
                    }),
                    (0, p.jsxs)(`div`, {
                      ...
                      children: [
                        (0, p.jsxs)(`div`, {
                          children: [
                            (0, p.jsx)(`small`, { children: `两人费用` }),
                            (0, p.jsx)(`strong`, { children: e.price }),
                          ],
                        }),
                        e.link
                          ? (0, p.jsx)(`a`, {
      ...
      (0, p.jsxs)(`section`, {
        ...
        children: [
            ...
            children: [
              (0, p.jsxs)(`div`, {
                children: [
                  (0, p.jsx)(`p`, {
                    className: `eyebrow`,
                    children: `03 / BOOKING BOARD`,
                  }),
                  (0, p.jsx)(`h2`, { children: `预订作战板` }),
                ],
              }),
              (0, p.jsxs)(`div`, {
                className: `progress`,
                children: [
                  (0, p.jsxs)(`b`, {
                    children: [Math.round((re.size / g.length) * 100), `%`],
                  }),
                  (0, p.jsx)(`span`, { children: `已锁定＋本设备完成` }),
                ],
              }),
            ],
          }),
          (0, p.jsx)(`div`, {
            ...
            children: (0, p.jsx)(`i`, {
              style: { width: `${(re.size / g.length) * 100}%` },
            }),
          }),
          (0, p.jsx)(`p`, {
            className: `fine`,
            children: `公开页面仅记录非敏感行程与金额；订单号、票号和证件信息不在此展示。`,
          }),
          [`航班`, `住宿`, `活动`, `交通`, `手续`].map((e, t) =>
            (0, p.jsxs)(
              `div`,
              {
                ...
                children: [
                  ...
                  (0, p.jsx)(`div`, {
                    children: g
                      ...
                      .map((e) => {
                        let t = e[6] === `locked`,
                          n = t || o.value.includes(e[0]);
                        return (0, p.jsxs)(
                          `article`,
                          {
                            className: n ? `book-card checked` : `book-card`,
                            children: [
                              (0, p.jsx)(`button`, {
                                disabled: t,
                                onClick: () => !t && o.toggle(e[0]),
                                "aria-pressed": n,
                                "aria-label": `标记${e[2]}`,
                                children: n ? `✓` : ``,
                              }),
        ...
        children: (0, p.jsxs)(`div`, {
          ...
          children: [
              ...
              children: [
                (0, p.jsxs)(`div`, {
                  children: [
                    (0, p.jsx)(`p`, {
                      className: `eyebrow`,
                      children: `04 / COST RANGE · CNY`,
                    }),
                    (0, p.jsx)(`h2`, { children: `两人主行程预算` }),
                  ],
                }),
                (0, p.jsxs)(`div`, {
                  className: `switch`,
            ...
            (0, p.jsxs)(`div`, {
              className: `total`,
              children: [
                (0, p.jsx)(`span`, { children: `可执行区间` }),
                (0, p.jsxs)(`b`, {
                  children: [`¥`, x(l / d), ` — `, x(u / d)],
                }),
                (0, p.jsx)(`small`, {
                  children: n ? `仅为总额 ÷ 2；10.06—10.08 实为 1 人费用` : `两人主段＋一人延长段；不含未知改签差额和购物`,
                }),
              ],
            }),
            (0, p.jsx)(`div`, {
                    ...
                    children: [
                      (0, p.jsxs)(`div`, {
                        children: [
                          (0, p.jsx)(`i`, {
                            style: {
                              background: t === 3 ? `#e56a36` : `#78aab5`,
                            },
                          }),
                          (0, p.jsx)(`b`, { children: e[0] }),
                        ],
                      }),
                      (0, p.jsx)(`span`, {
                        children: (0, p.jsx)(`i`, {
                          style: {
                            width: `${Math.max(10, e[2] / 350)}%`,
                            background: t === 3 ? `#e56a36` : `#78aab5`,
                          },
                        }),
                      }),
                      (0, p.jsxs)(`strong`, {
                        children: [`¥`, x(e[1] / d), `–`, x(e[2] / d)],
                      }),
                    ],
                  },
                  e[0],
            ...
            (0, p.jsxs)(`div`, {
              ...
              children: [
                (0, p.jsxs)(`div`, {
                  ...
                  children: [
                    (0, p.jsxs)(`div`, {
                      children: [
                        (0, p.jsx)(`small`, {
                          children: `ACTUAL COST TRACKER`,
                        }),
                        (0, p.jsx)(`h3`, { children: `实际费用登记` }),
                      ],
                    }),
                    (0, p.jsxs)(`b`, {
                      children: [
                ...
                (0, p.jsxs)(`div`, {
                  className: `fx-note`,
                  children: [
                    (0, p.jsxs)(`b`, { children: [`FIXED FX · `, y.date] }),
                    (0, p.jsxs)(`span`, {
                      children: [`1 USD = ¥`, y.USD, ` · 1 NOK = ¥`, y.NOK],
                    }),
                    (0, p.jsx)(`small`, {
                      children: `已支付外币项目按本快照固定；已预订但未支付项目暂按同一汇率估算。实际总账已包含 10.06—10.08 个人奥斯陆延长住宿。`,
                    }),
                  ],
                }),
                v.map((e) =>
                  (0, p.jsxs)(
                    ...
                    {
                      children: [
                        (0, p.jsx)(`time`, { children: e[0] }),
                        (0, p.jsx)(`span`, { children: e[1] }),
                        (0, p.jsx)(`strong`, { children: e[2] }),
                        (0, p.jsxs)(`b`, {
                          children: [
                            e[4] === `CNY`
                              ? `¥`
            ...
            (0, p.jsxs)(`div`, {
              ...
              children: [
                (0, p.jsx)(`b`, { children: `预算纪律` }),
                (0, p.jsx)(`p`, {
                  children: `实际费用以确认单与费用总账为准；超预算时优先减少非核心活动，不压缩斯瓦尔巴天气与返程安全缓冲。`,
                }),
              ],
            }),
          ],
            ...
            children: [
              (0, p.jsxs)(`div`, {
                children: [
                  (0, p.jsx)(`p`, {
                    className: `eyebrow`,
                    children: `05 / FIELD KIT`,
                  }),
                  (0, p.jsx)(`h2`, { children: `装备清单` }),
                ],
              }),
              (0, p.jsx)(`p`, {
                children: `海风与湿冷比温度数字更难受：贴身排汗—中层保暖—外层防风防水。`,
              }),
            ],
          }),
          (0, p.jsx)(`div`, {
            className: `kit`,
            children: [`证件`, `穿着`, `设备`, `随身`].map((e) =>
              (0, p.jsxs)(
                `div`,
                {
                  children: [
        ...
        children: [
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`p`, {
                className: `eyebrow`,
                children: `06 / SAFETY PROTOCOL`,
              }),
              (0, p.jsx)(`h2`, { children: `在斯瓦尔巴，城市边界外不自由行` }),
            ],
          }),
          (0, p.jsxs)(`div`, {
            className: `safety-cards`,
            children: [
              (0, p.jsxs)(`article`, {
                children: [
                  (0, p.jsx)(`b`, { children: `01` }),
                  (0, p.jsx)(`h3`, { children: `跟持证向导` }),
                  (0, p.jsx)(`p`, {
                    children: `定居点外存在北极熊风险，户外活动交给当地专业运营方。`,
                  }),
                ],
              }),
              (0, p.jsxs)(`article`, {
                children: [
                  (0, p.jsx)(`b`, { children: `02` }),
                  (0, p.jsx)(`h3`, { children: `天气决定路线` }),
                  (0, p.jsx)(`p`, {
                    children: `海况、风和能见度可能改线或取消，备用日是安全余量。`,
                  }),
                ],
              }),
              (0, p.jsxs)(`article`, {
                children: [
                  (0, p.jsx)(`b`, { children: `03` }),
                  (0, p.jsx)(`h3`, { children: `保险写清极地` }),
                  (0, p.jsx)(`p`, {
                    children: `确认斯瓦尔巴、搜救、医疗转运与行程取消不在免责范围。`,
                  }),
                ],
              }),
            ],
          ...
          (0, p.jsxs)(`div`, {
            ...
            children: [
              (0, p.jsx)(`a`, {
                href: `https://en.visitsvalbard.com/visitor-information/safety-in-svalbard`,
                target: `_blank`,
                rel: `noreferrer`,
                children: `Visit Svalbard 安全说明 ↗`,
              }),
              (0, p.jsx)(`a`, {
                href: `https://www.sysselmesteren.no/en/`,
                target: `_blank`,
                rel: `noreferrer`,
                children: `斯瓦尔巴总督官网 ↗`,
              }),
              (0, p.jsx)(`a`, {
                href: `https://www.yr.no/en/forecast/daily-table/2-2729907/Norway/Svalbard/Longyearbyen`,
                target: `_blank`,
                rel: `noreferrer`,
                children: `朗伊尔城天气 ↗`,
              }),
      ...
      (0, p.jsxs)(`footer`, {
        children: [
          (0, p.jsx)(`b`, { children: `78°` }),
          (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`strong`, { children: `北纬 78° · ARCTIC FIELD LOG` }),
              (0, p.jsx)(`p`, {
                children: `核对日期：2026.09.25 · 航班用当地抵达日、住宿按每个入住夜逐晚对应；未登记改签费用不计入总账。`,
              }),
            ],
          }),
          (0, p.jsx)(`a`, { href: `#top`, children: `回到地图 ↑` }),
        ],
      }),
    ],
  });
